...
class CancelPaymentTest extends TestCase
{
    ...
    {
        $cancel = new CancelPaymentForTests($this->config, $this->client);
        $result = $cancel->request('59386e0a5f258ffed3bee6fecc9150f916d1e19aa50ec68c');

        $this->assertArrayHasKey('payment', $result);
    }
}

class CancelPaymentForTests extends CancelPayment
{
